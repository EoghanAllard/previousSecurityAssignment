...
//                        .requestMatchers("/", "product", "product/").permitAll() // Specifies that requests to the root URL ("/") and "/goodbye" are allowed without authentication. This means anyone can access these routes.
